...
<nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: yellow;">
    <!-- Left navbar links -->
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ url('sql') }}" class="nav-link">Kembali</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ url('learning') }}" class="nav-link">Home</a>
      </li>
      <!--
      <li class="nav-item d-none d-sm-inline-block">
